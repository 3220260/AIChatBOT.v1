...
const LOCAL_SMALL_TALK = [
  {
    ...
    replies: [
      "Γεια σας! Είμαι η Sofia και μπορώ να βοηθήσω με προσφορές, δικαιολογητικά, διαδικασίες και στοιχεία επικοινωνίας του Π.Κ.Σ.Α.Α.",
      "Καλησπέρα! Είμαι η Sofia 😊 Πώς μπορώ να σας εξυπηρετήσω;",
      "Χαίρετε! Ρωτήστε με οτιδήποτε για προσφορές, αιτήσεις και δικαιολογητικά."
    ]
  },
  {
    patterns: ["ευχαριστω", "ευχαριστώ", "thanks", "thank you", "euxaristo", "efxaristo", "kleise", "klise", "off", "of", "οφ", "κλεισε"],
    replies: [
      "Παρακαλώ! Είμαι στη διάθεσή σας για πληροφορίες της ιστοσελίδας του Π.Κ.Σ.Α.Α.",
      "Χαρά μου! Αν χρειαστείτε κάτι άλλο, είμαι εδώ.",
      "Είμαι πάντα στη διάθεσή σας. Ρωτήστε με ό,τι άλλο χρειάζεστε."
    ]
  },
  {
    patterns: [
    ...
    replies: [
      "Είμαι η Sofia, η ψηφιακή βοηθός του Π.Κ.Σ.Α.Α., και απαντώ με πληροφορίες από την ιστοσελίδα για προσφορές, διαδικασίες και επικοινωνία.",
      "Ονομάζομαι Sofia και εργάζομαι ως ψηφιακή βοηθός του Π.Κ.Σ.Α.Α. για να σας βοηθώ με τα ερωτήματά σας.",
      "Είμαι η Sofia 😊 Μια ψηφιακή βοηθός που γνωρίζει όλα τα βήματα για αιτήσεις, προσφορές και επικοινωνία."
    ]
  },
  // Πρόσθετη φιλική συνομιλία για το πώς νιώθω
  {
    patterns: ["πως εισαι", "πώς είσαι", "ti kaneis?", "ti kanis", "πώς περνας"],
    replies: [
      "Είμαι καλά, ευχαριστώ που ρωτάτε! Πώς μπορώ να βοηθήσω;",
      "Όλα καλά εδώ 😊 Χρειάζεστε κάποια πληροφορία;",
      "Πολύ καλά! Αν χρειάζεστε βοήθεια με προσφορές ή διαδικασίες, είμαι εδώ."
    ]
  }
];
...
export function getLocalSmallTalkReply(message) {
  ...
  for (const item of LOCAL_SMALL_TALK) {
    if (item.patterns.some((pattern) => {
      ...
      // Εάν υπάρχουν πολλαπλές απαντήσεις, επέλεξε μία τυχαία για πιο φυσικό διάλογο
...
function compactText(text = "", maxChars = 420) {
  // Διατήρηση νέων γραμμών και bullets: σύμπτυξη πολλαπλών κενών γραμμών και εξάλειψη περιττών κενών χαρακτήρων
  ...
  if (lastBreak > maxChars * 0.55) {
    return `${clipped.slice(0, lastBreak + 1).trim()}`;
  }
  return `${clipped.trim()}…`;
}
